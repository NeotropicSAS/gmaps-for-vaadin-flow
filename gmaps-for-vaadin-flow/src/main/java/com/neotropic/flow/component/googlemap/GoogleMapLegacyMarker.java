 ...
 */
@Tag("google-map-legacy-marker")
@JsModule("./gmaps-legacy-marker.js")
public class GoogleMapLegacyMarker extends Component {
    public GoogleMapLegacyMarker(double lat, double lng) {
