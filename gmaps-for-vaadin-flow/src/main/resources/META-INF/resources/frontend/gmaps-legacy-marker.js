 ...
 */
class GoogleMapLegacyMarker extends PolymerElement {
  static get is() {
    return Constants.googleMapLegacyMarker;
  }
  static get template() {
    return html`
      <style>
...
window.customElements.define(GoogleMapLegacyMarker.is, GoogleMapLegacyMarker);